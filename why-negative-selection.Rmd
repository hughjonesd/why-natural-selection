...
* Plot average scores over time, as an intro graph. DONE
  - Can we work out how to plot selection effects on the "same scale"?
  - Simplest thing would be to use birth dates of children. (Maybe average of
    first and last live birth)
  - Also weight?

* How much does age at first live birth "account for" selection?
  - Need f.3872 age at flb for women with one child
...
res_combined %>% 
      ...
      ggplot(aes(y = score_name, x = estimate, fill = Regression, 
        ...
        geom_point(shape = 21, size = 1.8, stroke = 0.8) + 
        scale_color_manual(values = pval_palette) +
