...
dominate income effects overall, in accordance with the widespread association 
...
pattern we observe: earnings-increasing variants lead to later first births (and
fewer children overall), but more children for any given AFLB.
...
[@baudin2015fertility].If so, then earnings-increasing genetic variants may
decrease fertility more among single parents than among couples, as in our data.
The same idea could explain our results for lifetime number of sexual partners,
if this is associated with relationship stability.
