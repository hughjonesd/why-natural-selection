...
individual principal components themselves. As Figure \@ref(fig:plot-pc-regs) shows,
there are many more large and significant effects  in siblings regressions.


```{r plot-pc-regs, fig.cap = "Effect of principal components on number of siblings/children. Each dot represents one principal component. Points are jittered on the Y axis.", fig.height = 2}
