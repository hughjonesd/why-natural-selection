...
individual differences in complex traits and disease risk arise. Geneticists
have long hypothesized that natural selection is taking place in modern human
populations [@galton1869hereditary;@darwin1871the]; recent work confirms this 
...
natural selection increases inequality for 29 out of 33 polygenic scores 
(Appendix Table \@ref(tab:tbl-inequality-effects)).
...
uses respondents' scores weighted by Age/Qualification times number of
children. Column "Without selection" uses scores weighted by Age/Qualification
