...
\externaldocument{why-natural-selection}
...
$N_{1}^{*}=0$. To show global concavity of $N^{*}$ in $h$ as $\sigma\nearrow1$,
...
\textbf{Fact 2 part 2}: for $\sigma<1$ and close to 1, the fertility-human
capital relationship is weaker among higher earners.

\textbf{Fact 4}: for $\sigma<1$ and close to 1, the fertility-human
...
\textbf{Fact 5}: for $\sigma<1$ and close to 1, the fertility-human
capital relationship is weaker among those who start fertility late.

Lastly, we prove fact 3. Differentiating $dN_{t}^{*}/dh$ in (\ref{eq:dNdh1})
...
\textbf{Fact 3}: for $\sigma<1$, the fertility-human capital relationship
