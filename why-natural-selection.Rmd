...
*Weighted regressions only*: in addition to the above, 
major depressive disorder shows diversifying selection
and drinks per week show balancing selection.
...
```{r plot-regs-controlled-pcs, fig.cap = "Selection effects using unresidualized polygenic scores on number of siblings/children. Sibling estimates weighted by 1/number of siblings.", fig.height = 6}
