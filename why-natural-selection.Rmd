---
title: "Natural selection in contemporary humans is driven by correlations with human capital"
...
further affected by weighting on other demographic variables.[^purifying]
...
potential sources of ascertainment bias, as mentioned above.
...
question. However, the measure *does* predict the overall number of children,
highly significantly ($p \le 2^{-16}$, `r n_risk_sig`/33 regressions). Given that,
and our large N, we believe that the non-result is real: while risk aversion does
predict fertility in the sample, it is not an important channel for natural 
selection.
...
outcome of a universal, society-wide phenomenon. Instead they result from a sum
of opposing forces, operating in different parts of society and pulling in
