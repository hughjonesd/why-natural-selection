...
* We estimate the causal effect of each PGS on fertility using within-sibling
  regressions.
  - These are causal due to lottery of meiosis
  - Also do the fertility PGS
  
  
* We also estimate the effect of PSEA and fertility PGS on education and
  earnings, again within-siblings
  - confirm PSEA affects both; does fertility? What if we put both in together?
* Lastly we again estimate effect of PSEAs on fertility, 
  controlling for education and earnings in first job. 
  - We cannot exclude some reverse causality from EA3 -> fertility -> education/income
  - Our theory indeed assumes that people simultaneously choose N and s, while taking into
    account their effect on Y. We don't make claims about exogenous (chance) variation
    in Y or in N. But note that exog variation in N1 (i.e. no choice, treat
    it as fixed to different values) would affect s. OTOH, if EA3 affects $a$ and
    thereby changes things, you don't get predictions 2 or 4.
