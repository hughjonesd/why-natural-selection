...
predictor of lifetime earnings.^[animation] The raw relationships (left column) are strongly
...
^[animation]: See also the supplementary animation at https://xxx.xxx.xxx
...
potentially increase health inequalities. In general, the demographic history of
anatomically modern humans is related to disease risk [@benton2021influence];
understanding the role of contemporary natural selection may help in the design
of health policies.
