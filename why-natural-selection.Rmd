...
differences in complex traits and disease risk arise. Recent work confirms that
...
We created polygenic scores for 33 traits in `r nrow(famhist)` individuals,
corrected for ancestry using 100 genetic principal components (see Materials and
Methods). Figure \@ref(fig:plot-means-over-time) plots mean polygenic scores in
the sample by 5-year birth intervals. Several scores show consistent increases
or declines over this 30-year period, of the order of 5% of a standard
...
[@10.1093/aje/kwx246]. Since richer and educated people also live longer, this
...
controlling for AFLB. Note that we do not claim that AFLB is exogenous to an
individual's polygenic scores -- indeed, our analyses show that it is not
(Appendix Figure \@ref(fig:plot-age-flb-dv)). Rather, we argue that AFLB mediates
part of the relationship between polygenic scores and fertility, and that
once this is controlled for, the remaining part of the relationship has the
opposite sign.

AFLB mediates
the relationship between polygenic scores and fertility, and that after this
effect has been taken account of, there is a further, opposite-signed relationship.
...
in the opposite direction among older parents, whereas the economic theory can
...
selection effects of PGS with their genetic correlation with educational
...
results. Figure \@ref(fig:plot-rgs-by-effect-size) shows this is so. Genetic
