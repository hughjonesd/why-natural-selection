...
res_mediation %>% 
      ...
      ggplot(aes(y = term)) + 
        ...
        scale_fill_manual(values = c("FALSE" = "grey65", "TRUE" = "darkgreen")) +
        my_vline +
...
green bars show the actual means, i.e. parents' mean polygenic score weighted by
...
```{r plot-mean-EA3-by-income, fig.align = "center", fig.cap = "Mean polygenic score for educational attainment (EA3) of children by household income group. Green is actual. Grey is hypothetical in the absence of selection effects.", fig.width = 4}
income_EA3 <- famhist %>% 
