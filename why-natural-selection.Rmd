...
are smaller at higher incomes and education levels. (Indeed, in the model, the
effect of $a$ on fertility becomes stronger at higher levels of human capital.) A
third alternative is that traits under selection are linked to externalizing
behaviour and risk-seeking. This might be partially captured by our
risk-aversion parameter $\sigma$, which affects fertility by changing the
