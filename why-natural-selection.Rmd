...
Figure \@ref(fig:plot-res-wt) plots selection effects among the entire
...
large difference to estimates, increasing effect sizes by a mean of 
`r percent(mean_rel$Main - 1)`.[^weighting]
...
We emphasize that our categories are not necessarily exogenous to polygenic
scores. For example -- both in the data (Appendix Figure
\@ref(fig:plot-age-flb-dv)) and in our model -- age at first live birth is a
choice variable, which is endogenous to an individual's human capital and
related polygenic scores. Nevertheless, observed differences in equation
\@ref(eq:regression) across subgroups constrain the set of possible
theories; a good theory of contemporary natural selection needs to explain
how these results arise. As we show below, a model based on the economic
theory of fertility can do just that.
