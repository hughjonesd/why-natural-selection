...
This
study uses data from UK Biobank [@bycroft2018uk] to learn more about contemporary
natural selection. We test for
...
generations could lead to substantive effects in the long run. We then examine
reproductive rates in different subgroups of the population. 
...
the patterns in the data, while alternative explanations do not.
